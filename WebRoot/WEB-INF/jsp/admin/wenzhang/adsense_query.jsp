				...
				<tr>
						<td class="ta_01" align="left" bgColor="#afd1f3">
							<button type="button" id="add" name="add" value="添加" class="button_add"
							 onclick="window.location.href='${pageContext.request.contextPath}/admin/article/adsense_add.action?action=index'">
&#28155;&#21152;
						</td>
	...
	if(!ids)return; 
	App.del("${pageContext.request.contextPath}/admin/article/adsense_delete.action",ids);
	
	}
	
	function onEdit(id){
		getRequest("${pageContext.request.contextPath}/admin/article/adsense_update.action",{action:"index",id:id});
	}
	
	function mdel(id){
		App.del("${pageContext.request.contextPath}/admin/article/adsense_delete.action",[id]);
	}
